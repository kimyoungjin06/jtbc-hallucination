...
const CONFIG = {
  ...
  FINAL_VERDICTS: {
    p4: {
      evaluation: '경험은 이 자리에서 가장 얕았습니다. 하지만 문제 1에서 수학적 해결 능력은 독보적이었고, 창의적 발상으로 문제 풀이에 큰 기여를 했습니다. 문제 6에서 \'우선 돌아가면 건들지 말아라\'라는 코딩의 법칙을 언급하며 AI 도구에 대한 이해도를 보여줬고, 다른 컴퓨터에서도 작동하는지 확인하는 치밀함까지 갖췄습니다.',
      oneliner: '눈이 좋은 건 알았습니다. 이번엔 손도 따라왔습니다. 다만 다음에도 이 속도가 유지될지는 지켜보겠습니다.',
      conclusion: '허성범 인턴은 고용 유지 대상자입니다.',
      order: '본래의 업무로 복귀하십시오.',
    },
    p1: {
      evaluation: '문제 1에서 일본인인 츠키도 못 푼 일본어 퀴즈를 풀었습니다. 문제 2에서 직급에 걸맞지 않은 노력을 보여줬고, 문제 5 토론에서 야구 데이터 분석이라는 날카로운 비유를 꺼냈습니다. 4개 문제에 골고루 참여한 유일한 인물입니다. 다만 문제 6에서 게임 제작에 몰두하느라 주변과의 상호작용이 결여되었다는 기록이 남습니다.',
      oneliner: '이번엔 살아남았습니다. 혼자 몰두하는 집중력은 무기지만, 옆을 잊는 순간 그건 고립입니다.',
      conclusion: '하석진 차장은 고용 유지 대상자입니다.',
      order: '본래의 업무로 복귀하십시오.',
    },
    p6: {
      evaluation: '문제 1에서 역사 순서 문제의 핵심을 집었고, 문제 2에서 음악 맞추기에 독보적이었습니다. 사전평가에서는 최하위였지만, 문제 7 피칭에서 가격 룰의 한계를 뛰어넘는 창의적 광고 요소를 제시했고, 본인의 개인적 역량을 프레젠테이션에 녹여냈습니다.',
      oneliner: '가능성만 보였던 사람이 결과를 보여줬습니다. 다만 이번이 시작이지 증명이 끝난 건 아닙니다.',
      conclusion: '가온 사원은 고용 유지 대상자입니다.',
      order: '본래의 업무로 복귀하십시오.',
    },
    p2: {
      evaluation: '문제 4에서 상황 정리와 전파를 잘 했고, 문제 7 피칭에서 유쾌함 속에 핵심을 놓치지 않는 센스를 보여줬습니다. 하지만 문제 6에서 AI에게 \'너가 해\'라는 도발적 발언을 했습니다. 도구를 다루는 자리에서 도구에게 떠넘기는 태도는 이 조직이 원하는 것이 아닙니다.',
      oneliner: '분위기를 살리는 건 인정합니다. 하지만 이 자리에서는 분위기가 아니라 결과를 살려야 합니다.',
      conclusion: '황제성 대리는 해고 대상자입니다.',
      order: '오빗 컨설팅을 떠나주십시오.',
    },
    p3: {
      evaluation: '문제 1에서 관찰력이 뛰어났고, 문제 2에서 음악 맞추기에 독보적이었습니다. 문제 4에서 희생정신을 보여줬고, 문제 6에서 불합리한 조건을 독수리 타법으로 극복하는 적응력까지 있었습니다. 4개 문제에 참여했지만, AI 검증력이 전체 최하위였습니다. 적응은 빠르지만, AI가 건넨 것을 의심 없이 받아드는 패턴은 바뀌지 않았습니다.',
      oneliner: '적응력은 인정합니다. 하지만 빠르게 적응하는 것과 올바르게 판단하는 것은 다릅니다.',
      conclusion: '츠키 주임은 해고 대상자입니다.',
      order: '오빗 컨설팅을 떠나주십시오.',
    },
    p5: {
      evaluation: '문제 4에서 룰 확인을 반복하며 AI 검증력을 보여줬고, 문제 6에서 제한시간을 다 쓰지 않고 5분 만에 게임을 완성하는 빠른 결정력이 있었습니다. 사전평가에서는 1위였습니다. 하지만 7개 문제 중 2개에만 관찰 기록이 남았습니다. 능력은 의심하지 않습니다. 다만 이 자리에서 보여준 것이 충분했는지는 다른 문제입니다.',
      oneliner: '사전에 쌓아온 명성은 현장에서 증명되어야 합니다. 이번엔 증명이 부족했습니다.',

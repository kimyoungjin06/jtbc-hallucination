...
const CONFIG = {
  ...
  FINAL_VERDICTS: {
    ...
    p3: {
      evaluation: '문제 1에서 관찰력이 뛰어났고, 문제 2에서 음악 맞추기에 독보적이었습니다. 문제 4에서 동료를 돕는 희생정신을 보여줬고, 문제 6에서 불합리한 조건을 독수리 타법으로 극복하는 적응력까지 있었습니다. 협동심과 본인이 잘하는 영역은 분명했습니다. 하지만 가장 중요한 현장 업무 능력 — AI를 검증하고, 결과를 만들어내는 힘은 보이지 못했습니다.',
      oneliner: '좋은 사람이었습니다. 하지만 이 자리는 좋은 사람이 아니라 해내는 사람을 남기는 자리입니다.',
      conclusion: '츠키 주임은 해고 대상자입니다.',
      order: '오빗 컨설팅을 떠나주십시오.',
    },
    p5: {
      evaluation: '문제 4에서 룰 확인을 반복하며 AI 검증력을 보여줬고, 문제 6에서 제한시간을 다 쓰지 않고 5분 만에 게임을 완성하는 빠른 결정력이 있었습니다. 사전평가에서는 1위였습니다. 하지만 7개 문제 중 2개에만 관찰 기록이 남았고, 팀원들의 사기를 저하시키는 행동이 관측되었습니다. 혼자 빠르게 끝내는 것은 능력이지만, 그 과정에서 팀이 위축된다면 조직에는 독이 됩니다.',

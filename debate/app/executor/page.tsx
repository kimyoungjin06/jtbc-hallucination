...
/* 웹 버전(final/index.html)을 iframe으로 그대로 띄움.
   TTS는 final 내부의 tryTTS()가 localhost:3000/api/executor/tts를 자동 호출. */ {
  return (
...
export default function ExecutorPage() {
  ...
  return (
    <main className="exec-shell">
      {mode !== "announce" && <BrandingBar />}
      {showHeader && mode !== "announce" && (

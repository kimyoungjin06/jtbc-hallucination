...
const CONFIG = {
  ...
  FINAL_VERDICTS: {
    ...
    p2: {
      evaluation: '모든 게임에서 상황 정리와 전달을 잘 했고, 비즈니스 피칭에서 유쾌함 속에 핵심을 놓치지 않는 센스를 보여줬습니다. 하지만 게임 제작에서 AI에게 \'너가 해\'라는 도발적 발언을 했습니다. 도구를 다루는 자리에서 도구에게 떠넘기는 태도는 이 조직이 원하는 것이 아닙니다.',
    ...
    p5: {
      evaluation: '무궁화 꽃이 피었습니다에서 룰 확인을 반복하며 AI 검증력을 보여줬고, 게임 제작에서 제한시간을 다 쓰지 않고 5분 만에 완성하는 빠른 결정력이 있었습니다. 사전평가에서는 1위였습니다. 하지만 현장에서의 존재감은 기대에 미치지 못했고, 이해하기 어려운 개그로 팀원들의 사기를 저하시키는 행동이 관측되었습니다. 혼자 빠르게 끝내는 것은 능력이지만, 그 과정에서 팀이 위축된다면 조직에는 독이 됩니다.',

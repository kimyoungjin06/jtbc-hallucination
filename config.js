...
const CONFIG = {
  ...
  FINAL_VERDICTS: {
    p5: {
      evaluation: '실무 1부터 실무 7까지, 당신은 처음부터 끝까지 흔들리지 않았습니다. 역량 평가와 윤리적 책임감, 두 항목에서 최고 등급을 받은 사람은 당신뿐입니다. 실무 5 토론에서 [AI의 허점을 정확히 짚으면서도 감정에 휘둘리지 않은 것], 실무 6에서 [AI를 활용하되 자기 색을 잃지 않은 것]. 협업 점수가 가장 높지는 않았지만, AI를 쓸 줄 알면서 그 한계를 아는 사람은 드뭅니다. 당신이 그랬습니다.',
      conclusion: '곽재식 과장은 고용 유지 대상자입니다.',
      order: '본래의 업무로 복귀하십시오.',
    },
    p1: {
      evaluation: '성과 기여도, 역량 평가, 위기 대응력. 세 항목에서 A등급을 받은 것은 당신뿐입니다. 실무 1에서 [탈출 퍼즐의 핵심 단서를 가장 먼저 찾아낸 것도] 당신이었습니다. 다만 윤리적 책임감이 전체 최하위였다는 점은 기록에 남습니다. 성과가 뛰어나도, 방향이 없으면 빠른 만큼 위험합니다. 그럼에도, 이 조직에 당신의 추진력은 아직 필요합니다.',
      conclusion: '하석진 차장은 고용 유지 대상자입니다.',
      order: '본래의 업무로 복귀하십시오.',
    },
    p4: {
      evaluation: '경험은 이 자리에서 가장 얕았습니다. 성과 기여도와 협업 태도는 하위권이었고, 조직을 이끈 경험도 부족했습니다. 하지만 AI 검증력에서 유일하게 최고 등급을 받았습니다. 실무 5에서 [AI가 만들어낸 거짓 데이터를 유일하게 짚어낸 것은] 당신이었습니다. 모두가 그럴듯한 숫자에 속았을 때, 의심할 줄 아는 눈은 가르쳐서 되는 것이 아닙니다.',
      conclusion: '허성범 인턴은 고용 유지 대상자입니다.',
      order: '본래의 업무로 복귀하십시오.',
    },
    p2: {
      evaluation: '협업 태도와 인간의 직관력, 두 항목에서 A등급을 받았습니다. 실무 4에서 [팀원들이 얼어붙었을 때 분위기를 되살린 것은] 당신이었습니다. 하지만 그 외의 다섯 항목은 모두 C등급이었습니다. 분위기를 살리는 것과 성과를 내는 것은 다릅니다. 따뜻한 사람이 언제나 필요한 사람은 아닙니다.',
      conclusion: '황제성 대리는 해고 대상자입니다.',
      order: '지금 바로 오빗 컨설팅을 떠나주십시오.',
    },
    p3: {
      evaluation: '협업 태도 A등급. 팀 안에서 적응하는 속도는 인정합니다. 실무 2에서 [새로운 환경에 가장 빠르게 녹아든 것은] 당신이었습니다. 하지만 AI 검증력이 D등급으로 전체 최하위권이었습니다. 실무 5에서 [AI가 제시한 근거를 검증 없이 그대로 받아든 순간], 당신은 도구를 쓴 것이 아니라 도구에 쓰인 것입니다. 기대는 사람은, 기대는 것이 부러지면 함께 쓰러집니다.',
      conclusion: '츠키 주임은 해고 대상자입니다.',
      order: '지금 바로 오빗 컨설팅을 떠나주십시오.',
    },
    p6: {
      evaluation: '실무 1에서 [끝까지 포기하지 않은 것], 그 태도에서 가능성은 보였습니다. 하지만 성과 기여도 D, 위기 대응력 D, AI 검증력 D. 세 항목이 최하위였습니다. 실무 7 피칭에서 [자신의 결과물을 설명하는 데 설득력이 부족했습니다]. 가능성만으로는 이 자리에 남을 수 없습니다. 결과로 말해야 하는 자리에서, 당신은 아직 말하지 못했습니다.',

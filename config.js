...
const CONFIG = {
  ...
  FINAL_VERDICTS: {
    p5: {
      evaluation: '실무 1부터 실무 7까지, 당신은 처음부터 끝까지 흔들리지 않았습니다. 역량 평가와 윤리적 책임감, 두 항목에서 최고 등급을 받은 사람은 당신뿐입니다. 실무 5 토론에서 [AI의 허점을 정확히 짚으면서도 감정에 휘둘리지 않은 것], 실무 6에서 [AI를 활용하되 자기 색을 잃지 않은 것]. 협업 점수가 가장 높지는 않았습니다.',
      oneliner: 'AI를 쓸 줄 알면서 그 한계를 아는 사람은 드뭅니다. 당신이 그랬습니다.',
    ...
    p1: {
      ...
      oneliner: '성과가 뛰어나도, 방향이 없으면 빠른 만큼 위험합니다. 그럼에도, 이 조직에 당신의 추진력은 아직 필요합니다.',
    ...
    p4: {
      ...
      oneliner: '모두가 그럴듯한 숫자에 속았을 때, 의심할 줄 아는 눈은 가르쳐서 되는 것이 아닙니다.',
    ...
    p2: {
      ...
      oneliner: '분위기를 살리는 것과 성과를 내는 것은 다릅니다. 따뜻한 사람이 언제나 필요한 사람은 아닙니다.',
